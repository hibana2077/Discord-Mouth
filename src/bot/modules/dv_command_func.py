...
import modules.dv_tool_function as tool_function
from modules import tts_func
...
async def _get_web_title(client, url: str) -> Tuple[str, str]:
    try:
...
async def tts_convert(ctx, lang: str, content: str, platform_result: str) -> List[bool]:
    guild_id = ctx.guild.id
    ...
    # Maybe can add more TTS API here
